...
const allCoursesMasterData = [
    ...
    { id: "course-resume", category: "Career", name: "Create Digital Resume", img: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=800", desc: "Create digital resume from scratch.", link: "https://www.youtube.com/watch?v=n7SBzreUYt0" },
       ...
       // --- 5. BA courses ---
    { id: "course-money&banking", category: "ba", name: "Money & Banking", img: "https://imarticus.org/blog/wp-content/uploads/2024/07/money-and-banking-1200x675.jpg", desc: "धन, बैंकिंग सेवाओं और वित्तीय लेन-देन की मूलभूत जानकारी।", link: "https://youtube.com/playlist?list=PL-fORSyPTUELSJbl0YEsrvQjkoUqVeeXJ&si=vd7Ulwvv-Ce8hfr3" },
    { id: "course-geographycal_thouth", category: "ba", name: "Geographycal thought", img: "https://i0.wp.com/govtcollegetholanur.com/wp-content/uploads/2025/05/geo.jpg", desc: "भूगोल के सिद्धांतों, विचारों और मानव-पर्यावरण संबंधों का अध्ययन।", link: "https://youtube.com/playlist?list=PL5YWEqSxi0Dj8zmok3HihK7WEusSPGhUO&si=u9ATl2XoveE6gFmF" }
];
